...
<p align="center">
  <kbd>
    <kbd style="font-weight: bold; padding: 2px 6px;">Frontend</kbd>
    <br><br>
  ...
  <br><br>
  <kbd>
    <kbd style="font-weight: bold; padding: 2px 6px;">Backend</kbd>
    <br><br>
  ...
  <br><br>
  <kbd>
    <kbd style="font-weight: bold; padding: 2px 6px;">Framework</kbd>
    <br><br>
    <img width="40px" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/laravel/laravel-original.svg" title="Laravel" />
  </kbd>
  <br><br>
  <kbd>
    <kbd style="font-weight: bold; padding: 2px 6px;">Database</kbd>
    <br><br>
